        ...
        try {
          ...
          if (status === "Approved") {
            setApprovedLeaves((prev) => [
              ...prev,
              { ...selectedLeave, status, comments },
            ]);
            toast.success("Leave Approved Successfully!");
          } else {
            setRejectedLeaves((prev) => [
              ...prev,
              { ...selectedLeave, status, comments },
            ]);
            toast.success("Leave Rejected Successfully!");
          }
          setSelectedLeave({ ...selectedLeave, status, comments });
        } catch (error) {
          setError(error.message);
        }
      }
    },
    [selectedLeave, leaves, setApprovedLeaves, setRejectedLeaves]
  );
