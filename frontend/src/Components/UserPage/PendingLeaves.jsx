...
const PendingLeaves = ({ setApprovedLeaves, setRejectedLeaves }) => {
  ...
  useEffect(() => {
    ...
    const storedRejectedLeaves = JSON.parse(localStorage.getItem('rejectedLeaves')) || [];
    setApprovedLeaves(storedApprovedLeaves);
    setRejectedLeaves(storedRejectedLeaves);
  ...
  const filteredLeaves = leaves.filter((leave) => {
    ...
    const nameCondition =
      ...
      leave.name.toLowerCase().includes(searchName.toLowerCase());
