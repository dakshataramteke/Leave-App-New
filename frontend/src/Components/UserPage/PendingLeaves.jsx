...
//       if (selectedLeave) {
//         try {
//           const response = await fetch(`http://localhost:5000/approved`, {
//             method: "post",
//             headers: {
...
//           if (response.ok) {
//             const approvedLeave = { ...selectedLeave, status, comments };
//             setApprovedLeaves((prev) => [...prev, approvedLeave]); // Update approved leaves
...
//       }
//     },
//     [selectedLeave, leaves, setApprovedLeaves]
//   );
//   const handleApprove = () => {
...
const PendingLeaves = ({ setApprovedLeaves, setRejectedLeaves }) => {
  ...
  const updateLeaveStatus = useCallback(
    ...
    [selectedLeave, leaves, setApprovedLeaves, navigate]
  );
